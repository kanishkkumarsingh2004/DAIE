...
class HybridChatConfig:
        ...
        try:
            ...
            if self.start_system:
                try:
                    ...
                    print(f"[+] Hybrid system started successfully!")
                except Exception as e:
    ...
    @classmethod
    def quick_start(cls, hybrid_system: Union[HybridOrchestratorNode, MultiNodeHybridSystem], **kwargs) -> "HybridChatConfig":
        """
