...
class MultiNodeChatConfig:
    ...
    >>> from daie.core.hybrid import MultiNodeHybridSystem
    >>> from daie.chat import MultiNodeChatConfig
    >>>
    ...
    >>> config = MultiNodeChatConfig(system=system)
    ... config.run()
    """
    ...
    @classmethod
    def quick_start(cls, system: MultiNodeHybridSystem, **kwargs) -> "MultiNodeChatConfig":
        """
        ...
        Returns:
            MultiNodeChatConfig instance ready to run
        ...
        >>> MultiNodeChatConfig.quick_start(system=system).run()
        """
