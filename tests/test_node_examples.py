...
class TestNodeLifecycle:
    ...
    @pytest.mark.asyncio
    async def test_node_start(self, mock_logger):
    ...
    @pytest.mark.asyncio
    async def test_node_stop(self, mock_logger):
    ...
    @pytest.mark.asyncio
    async def test_node_double_start(self, mock_logger):
    ...
    @pytest.mark.asyncio
    async def test_node_double_stop(self, mock_logger):
...
class TestMethodChaining:
    ...
    @pytest.mark.asyncio
    async def test_method_chaining_start(self, mock_logger):
    ...
    @pytest.mark.asyncio
    async def test_comprehensive_method_chaining(self, mock_logger):
...
class TestNodeStatus:
    ...
    @pytest.mark.asyncio
    async def test_active_node_status(self, mock_logger):
    ...
    @pytest.mark.asyncio
    async def test_status_reflects_all_changes(self, mock_logger):
...
class TestNodeStringRepresentation:
    ...
    @pytest.mark.asyncio
    async def test_str_representation_active(self, mock_logger):
...
class TestPracticalUseCases:
    ...
    @pytest.mark.asyncio
    async def test_setup_agent_host_node(self, mock_logger):
    ...
    @pytest.mark.asyncio
    async def test_node_decommissioning(self, mock_logger):
    ...
    @pytest.mark.asyncio
    async def test_node_health_check(self, mock_logger):
        ...
        health_ok = (
            ...
            and status["resources"]["cpu_usage"] < 80
            and status["resources"]["memory_usage"] < 90
        )
    ...
    @pytest.mark.asyncio
    async def test_fault_tolerant_design(self, mock_logger):
